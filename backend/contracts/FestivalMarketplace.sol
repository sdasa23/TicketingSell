...
contract FestivalMarketplace {
    ...
    function purchaseTicket(uint8 ticketLevel) public {
        ...
        _token.transferFrom(buyer, _organiser, _festival.getTicketPrice(ticketLevel));

        _festival.transferTicket(buyer, ticketLevel);
    }
    ...
    function secondaryPurchase(uint256 ticketId) public {
        ...
        _token.transferFrom(buyer, _organiser, commision);  // Should we transform commision to organiser? or don`t need it.
